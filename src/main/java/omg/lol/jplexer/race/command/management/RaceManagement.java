...
public class RaceManagement {
    ...
    public static List<String> TabCompleteCommand(String[] args) {
        ...
        if (args.length == 0) {
            ...
            return Arrays.asList("help", "register", "deregister", "stations", "addstation", "removestation", "close", "setterminalstation");
        } else {
    ...
    static void registerPlayer(CommandSender sender, String player) {
        ...
        for (Entity target : targets) {
            ...
            sender.sendMessage(CHAT_PREFIX + ChatColor.GREEN + sender.getName() + " has been added to the race");
        }
